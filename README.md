...
![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=2E86C1&center=true&width=600&lines=Hey%2C+I'm+Pavan+KM+%F0%9F%91%8B;Cybersecurity+Intern+%40+Beagle;VAPT+%7C+Red+Team+%7C+CTF+Player;Open+to+Remote+Roles+%26+Internships)
...
- Conducted and ran a competitive Attack & Persistence hacking event (CTF-style format)
- Built challenge scenarios covering exploitation, persistence, and lateral movement
- Managed participant coordination and technical infrastructure end-to-end
...
![Metasploit](https://img.shields.io/badge/Metasploit-2E2E2E?style=flat-square&logoColor=white)
...
![Gobuster](https://img.shields.io/badge/Gobuster-1C2333?style=flat-square&logoColor=white)
![Evil-WinRM](https://img.shields.io/badge/Evil--WinRM-1C2333?style=flat-square&logoColor=white)
![Nikto](https://img.shields.io/badge/Nikto-1C2333?style=flat-square&logoColor=white)
![Netcat](https://img.shields.io/badge/Netcat-1C2333?style=flat-square&logoColor=white)
...
### 🌐 [Personal Cybersecurity Portfolio](https://github.com/pavannkm/Personal-Portfolio)
My portfolio site — built to showcase my skills, projects, and VAPT experience. Designed and developed from scratch using a modern frontend stack.
> `React` `Vite` `Tailwind CSS` `Framer Motion`

### 🏰 [VulnNet: Roasted — AD Walkthrough](https://github.com/pavannkm/VulnNet-Roasted-Walkthrough)
Complete technical walkthrough of the VulnNet: Roasted Active Directory machine on TryHackMe. Covers Kerberoasting, AS-REP Roasting, SMB enumeration, credential cracking, and privilege escalation through a real AD environment.
> `Active Directory` `Kerberoasting` `AS-REP Roasting` `Evil-WinRM` `TryHackMe`
...
[![TryHackMe Stats](https://tryhackme-badges.s3.amazonaws.com/cs22.1693.png)](https://tryhackme.com/p/cs22.1693)
...
<div align="center">
<img src="https://github-profile-summary-cards.vercel.app/api/cards/stats?username=pavannkm&theme=tokyonight" height="180"/>
&nbsp;&nbsp;
<img src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=pavannkm&theme=tokyonight" height="180"/>
<br><br>

![GitHub Streak](https://streak-stats.demolab.com?user=pavannkm&theme=tokyonight&hide_border=true&date_format=j%20M%5B%20Y%5D)
...
![Snake animation](https://raw.githubusercontent.com/pavannkm/pavannkm/output/github-snake-dark.svg#gh-dark-mode-only)
![Snake animation](https://raw.githubusercontent.com/pavannkm/pavannkm/output/github-snake.svg#gh-light-mode-only)
...
<div align="center">
  <sub>Currently: writing CTF writeups · practicing AD attack chains · open to work</sub>
</div>
